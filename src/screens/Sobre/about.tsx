    ...
    return (
        <View>
            ...
            <Profiles>
                ...
                />
                <TextoProfiles>
                    Giovana gosta de trabalhar com python, tem estudado muito
                    sobre inteligência artificial. Atualmente trabalha com
                    engenharia de dados e cursa ciência da computação.
                </TextoProfiles>
            </Profiles>
            ...
            <Profiles>
                ...
                />
                <TextoProfiles>
                    Hemilly tem formação técnica em eletroeletronica, atualmente
                    está cursando o 3° semestre de Analise e Desenvolvimento de
            ...
            <Profiles>
                ...
                />
                <TextoProfiles>
                    Luana atualmente está trabalhando como Gerente de Projeto na
                    Aoop, uma startup com foco na implementação de Servicenow.
                    Cursando Análise e Desenvolvimento de TI, já em seu último
                    semestre.
                </TextoProfiles>
            </Profiles>
            ...
            <Profiles>
                ...
                />
                <TextoProfiles>
                    Maria Eduarda possui formação como técnica de informática,
                    atualmente está cursando o 3º semestre de Ciências da
                    Computação e focando seus estudos em front-end e na área de
                    de UI/UX
                </TextoProfiles>
            </Profiles>
            ...
            <Profiles>
                ...
                />
                <TextoProfiles>
                    Raquel trabalha como desenvolvedora Drupal na CI&T, gosta da
                    trabalhar com front-end e atualmente está focando seus
                    estudos em React JS
                </TextoProfiles>
            </Profiles>
            ...
            <Profiles>
                ...
                />
                <TextoProfiles>
                    Wagner é desenvolvedor Fullstack na CI&T, atualmente no
                    projeto do Itaú, trabalho com a stack Angular + Java + AWS
                    (aprendendo React e NextJs) e cursando o 5º semestre de
                    Ciência da Computação
                </TextoProfiles>
            </Profiles>
            ...
            <ContainerEmail>
                ...
                <TextEmail onPress={handleEmailPress}>
